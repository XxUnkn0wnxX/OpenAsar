...
const injectSettingsItem = () => {
  ...
  let advanced = findAppSettingsItem();
  if (!advanced) advanced = document.querySelector('[data-list-item-id="settings-sidebar___advanced_sidebar_item"]');
...
setInterval(syncSettingsInjection, 800);
